...
constexpr char START_BYTE = 0x02;  // Zaèiatoèný znak prenosu
constexpr char END_BYTE = 0x03;    // Závereèný znak prenosu
...
//    std::string message = EncodeData(NormalizeCoordinateX(x), NormalizeCoordinateY(y), speed, a, b, c, avgX);
//
